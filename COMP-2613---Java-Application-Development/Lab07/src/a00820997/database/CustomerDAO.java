...
public class CustomerDAO implements DAO {
	...
	public void create() throws SQLException {
		if (connection != null) {
			String createString = String.format("CREATE TABLE " + Lab07.TABLE_NAME
		...
		if (connection != null) {
			...
			if (ids.contains(String.valueOf(addCustomer.getId()))) {
				...
				String createString = String.format(
						"INSERT INTO %s values('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')", Lab07.TABLE_NAME,
	...
	public void deleteCustomer(int id) throws SQLException {
		if (connection != null) {
			String deleteString = "DELETE FROM " + Lab07.TABLE_NAME + " WHERE id = '" + id + "'";
	...
	public void readAll() throws SQLException {
		if (connection != null) {
			Statement statement = connection.createStatement();
			ResultSet rs = statement.executeQuery("SELECT * FROM " + Lab07.TABLE_NAME);
	...
	public Customer getCustomer(int id) throws SQLException {
		...
		if (connection != null) {
			String query = "SELECT * FROM " + Lab07.TABLE_NAME + " WHERE id='" + id + "'";
			Statement s = connection.createStatement();
	...
	public void updateCustomer(int id, String field, String newValue) throws SQLException {
		if (connection != null) {
			Statement s = connection.createStatement();
			String update = "UPDATE " + Lab07.TABLE_NAME + " SET " + field + " = '" + newValue + "' WHERE id = '?'";
	...
	public void drop() throws SQLException {
		Statement statement = connection.createStatement();
		String dropString = "DROP TABLE " + Lab07.TABLE_NAME;
	...
	public List<String> getIds() throws SQLException {
		...
		if (connection != null) {
			Statement s = connection.createStatement();
			ResultSet rs = s.executeQuery("SELECT id FROM " + Lab07.TABLE_NAME);
