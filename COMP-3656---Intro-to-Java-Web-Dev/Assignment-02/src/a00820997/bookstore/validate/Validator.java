...
package a00820997.bookstore.validate;
...
public class Validator {
	...
	/**
	 * Method to check an email address is valid. If the email is valid, return said
	 * email. If it is not valid, return "n/a"
	 *
	 * @param checkEmail the email address to be checked.
	 */
