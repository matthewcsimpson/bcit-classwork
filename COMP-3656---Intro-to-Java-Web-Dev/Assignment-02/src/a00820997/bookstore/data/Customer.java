...
public class Customer {
	...
	public static class Builder {
		 ...
		 *
		 * @param id          - a long - the ID to set
		 * @param phoneNumber - a string - the phone number to set
		 */
	 ...
	 *
	 * @param builder - the builder class data
	 */
	...
	/**
	 * @param city - a string - the city to set
	 */
	...
	/**
	 * @param emailAddress - a string - the emailAddress to set
	 */
	...
	/**
	 * @param firstName - a string - the firstName to set
	 */
	...
	/**
	 * @param joinDate - a string - * the joinDate to set
	 */
	...
	/**
	 * @param lastName - a string - the lastName to set
	 */
	...
	/**
	 * @param phoneNumber - a string - the phoneNumber to set
	 */
	...
	/**
	 * @param postalCode - a string - the postalCode to set
	 */
	...
	/**
	 * @param streetName - a string - the streetName to set
	 */
	...
	public String toString() {
		return "Customer [id=" + customerID + ", firstName=" + firstName + ", lastName=" + lastName + ", streetName="
				+ streetName + ", city=" + city + ", postalCode=" + postalCode + ", phoneNumber=" + phoneNumber
				+ ", emailAddress=" + emailAddress + ", joinDate=" + joinDate + "]";
	}
