...
public class BookOptions {
	 ...
	 * ‘purchases’ isn’t also specified by_title Sorts the purchases report by book
	 * title in ascending order. This option is ignored if ‘purchases’ isn’t also
	 * specified by_join_date Sorts the customer report by join date in ascending
	 * order. This option is ignored if ‘customers’ isn’t also specified desc Any
	 * sorted report is sorted in descending order. Must be combined with
	 * 'by_lastname', 'by_title', or 'by_join_date' customer_id=<id> Filters the
	 * purchases report, showing only customers that match the customer id
	 */
